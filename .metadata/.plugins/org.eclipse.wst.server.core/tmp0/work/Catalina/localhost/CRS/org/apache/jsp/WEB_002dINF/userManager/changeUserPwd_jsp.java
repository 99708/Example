 ...
 * Generated at: 2018-11-26 08:02:26 UTC
...
public final class changeUserPwd_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("\">\r\n");
      out.write("    \r\n");
      out.write("    <title>My JSP 'chengeUserPwd.jsp' starting page</title>\r\n");
      out.write("    \r\n");
      ...
      out.write("\t\t    var obj = document.getElementById('userPwd');\r\n");
      out.write("\t\t    var newPwd = document.getElementById('newUserPwd');\r\n");
      out.write("   \t\t\tvar okNewPwd = document.getElementById('okNewPwd');\r\n");
      out.write("   \t\t\tvar oldPwd = document.getElementById('oldPwd');\r\n");
      out.write("   \t\t\tif(oldPwd.value == null || oldPwd.value == \"\"){\r\n");
      out.write("   \t\t\t\talert(\"请输入旧密码\");\r\n");
      out.write("   \t\t\t\toldPwd.select(); \r\n");
      out.write("   \t\t\t\treturn false;\r\n");
      out.write("   \t\t\t}else if(newPwd.value == null || newPwd.value == \"\"){\r\n");
      out.write("   \t\t\t\talert(\"请输入新密码\");\r\n");
      out.write("   \t\t\t\tnewPwd.select();\r\n");
      out.write("   \t\t\t\treturn false;\r\n");
      out.write("   \t\t\t}else if(okNewPwd.value == null || okNewPwd.value == \"\"){\r\n");
      out.write("   \t\t\t\talert(\"请再次输入密码\");\r\n");
      out.write("   \t\t\t\tokNewPwd.select();\r\n");
      out.write("   \t\t\t\treturn false;\r\n");
      out.write("   \t\t\t}else{\r\n");
      out.write("\t   \t\t\tif(newPwd.value == okNewPwd.value){\r\n");
      out.write("\t   \t\t\t\tif(oldPwd.value == obj.value){\r\n");
      out.write("\t   \t\t\t\tdocument.forms[0].submit();\r\n");
      out.write("\t   \t\t\t\t}else{\r\n");
      out.write("\t   \t\t\t\talert(\"旧密码有误请重新输入\");\r\n");
      out.write("\t   \t\t\t\toldPwd.select();\r\n");
      out.write("   \t\t\t\t    return false;\r\n");
      out.write("\t   \t\t\t\t}\r\n");
      out.write("\t   \t\t\t\t\r\n");
      out.write("\t   \t\t\t}else{\r\n");
      out.write("\t   \t\t\t\talert(\"您输入的密码不一致，请重新输入。\");\r\n");
      out.write("\t   \t\t\t\tnewPwd.value = \"\";\r\n");
      out.write("\t   \t\t\t\tokNewPwd.value = \"\";\r\n");
      out.write("\t   \t\t\t\treturn ;\r\n");
      out.write("\t   \t\t\t}\r\n");
      out.write("   \t\t}\r\n");
      out.write("\t\t}\r\n");
      ...
      out.write("  \r\n");
      out.write("  <body>\r\n");
      out.write("   <form action=\"upPwd\" method=\"post\">\r\n");
      out.write("   <input type=\"hidden\" name=\"method\" value=\"changeUserPwd\"/>\r\n");
      ...
      out.write("     \t<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n");
      out.write("     \t\t <tr>\r\n");
      out.write("      <td width=\"14%\"><div align=\"right\" class=\"left_txt\">旧密码：</div></td>\r\n");
      out.write("      <td width=\"23%\"><input name=\"oldPwd\" type=\"password\"  id=\"oldPwd\" >*</td>\r\n");
      out.write("      </tr>\r\n");
      out.write("     \t <tr>\r\n");
      out.write("      <td width=\"14%\"><div align=\"right\" class=\"left_txt\">新密码：</div></td>\r\n");
      out.write("      <td width=\"23%\"><input name=\"newUserPwd\" type=\"password\" id=\"newUserPwd\" >* &nbsp;&nbsp;<span style=\"font-size: 12px;color: #1F4A65;\">新密码不能小于四位</span></td>\r\n");
      out.write("      </tr>\r\n");
      out.write("     \t <tr>\r\n");
      out.write("      <td width=\"14%\"><div align=\"right\" class=\"left_txt\">确认新密码：</div></td>\r\n");
      out.write("      <td width=\"23%\"><input name=\"okNewPwd\" type=\"password\" id=\"okNewPwd\" >*</td>\r\n");
      out.write("      </tr>\r\n");
      out.write("   </table>\r\n");
