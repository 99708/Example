...
public interface CarOperMapper {
	 ...
	 * @return
	 */
	Integer selectCountSLFByThree(String oper , Integer uid , String opertime);
	 ...
	 * @return
	 */
	List<SlfLog> selectAllSLFByOUO(String oper , Integer uid , String opertime , Integer num , Integer pageSize);
