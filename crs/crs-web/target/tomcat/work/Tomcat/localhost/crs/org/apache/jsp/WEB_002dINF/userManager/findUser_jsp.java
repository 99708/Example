 ...
 * Generated at: 2019-04-22 09:55:47 UTC
...
public final class findUser_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("            <a href=\"javascript:;\" class=\"crumbs-label\">查询用户信息</a>\r\n");
      out.write("        </div>\r\n");
      out.write("    </div>\r\n");
      out.write("\r\n");
      ...
      out.write("                        <div class=\"item-lt\">账号：</div>\r\n");
      ...
      out.write("                    </div>\r\n");
      out.write("                    <div class=\"kv-item\">\r\n");
      out.write("                        <div class=\"item-lt\">职位：</div>\r\n");
      out.write("                        <div class=\"item-rt\">\r\n");
      ...
      out.print(request.getContextPath() );
      out.write("/selUser\",\r\n");
      out.write("            data:\"uid=\"+$(\"#uid\").val()+\"&cname=\"+$(\"#cname\").val()\r\n");
      out.write("            +\"&uname=\"+$(\"#uname\").val()+\"&rname=\"+$(\"#rname\").val()+\"&pageNum=\"+pNum+\"&pageSize=\"+pSize,\r\n");
      ...
      out.write("\r\n");
      out.write("                for (var i = 0; i < rsData.lu.length; i++) {\r\n");
      out.write("                    var user = rsData.lu[i];\r\n");
      out.write("                    tb.append(\r\n");
      out.write("                        \"<tr>\"+\r\n");
      out.write("                        \"<td>\"+(i+1)+\"</td>\"+\r\n");
      out.write("                        \"<td>\"+user.uid+\"</td>\"+\r\n");
      out.write("                        \"<td>\"+user.idcard+\"</td>\"+\r\n");
      out.write("                        \"<td>\"+user.uname+\"</td>\"+\r\n");
      out.write("                        \"<td>\"+user.sex+\"</td>\"+\r\n");
      out.write("                        \"<td>\"+user.role.rname+\"</td>\"+\r\n");
      out.write("                        \"<td>\" +\r\n");
      out.write("                        \"<a href='javascript:void(0)' class='tablelink' onclick=\\\"showUser('\"+user.uid+\"')\\\">查看</a>&nbsp;&nbsp;\" +\r\n");
      out.write("                        \"<a href='javascript:void(0)' class='tablelink' onclick=\\\"upUser('\"+user.uid+\"')\\\">修改</a>&nbsp;&nbsp;\" +\r\n");
      out.write("                        \"<a href='javascript:void(0)' class='tablelink' onclick=\\\"delUser('\"+user.uid+\"')\\\">删除</a>\" +\r\n");
      out.write("                        \"</td>\"+\r\n");
      out.write("                        \"</tr>\");\r\n");
      out.write("                }\r\n");
      out.write("\r\n");
      ...
      out.write("                $(\"#pageId\").html(pageCount);//设置当前页码数\r\n");
      out.write("\r\n");
      out.write("                //显示分页页码\r\n");
      ...
      out.write("<script type=\"text/javascript\">\r\n");
      out.write("    //查看用户信息\r\n");
      out.write("    function showUser(uid) {\r\n");
      out.write("        window.location.href=window.location.href=\"");
      out.print(request.getContextPath() );
      out.write("/selUserById?uid=\"+uid;\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    //修改用户信息\r\n");
      out.write("    function upUser(uid) {\r\n");
      out.write("        window.location.href=window.location.href=\"");
      out.print(request.getContextPath() );
      out.write("/updateUserView?uid=\"+uid;\r\n");
      out.write("    }\r\n");
      out.write("    //删除用户信息\r\n");
      out.write("    function delUser(uid) {\r\n");
      out.write("        if(window.confirm(\"您确定要这么做吗？\")){\r\n");
      out.write("            window.location.href=window.location.href=\"");
      out.print(request.getContextPath() );
      out.write("/delUser?uid=\"+uid;\r\n");
      out.write("        }else{\r\n");
