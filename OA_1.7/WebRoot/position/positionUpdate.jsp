...
<html>
  <head>
    ...
    <title>My JSP 'positionUpdate.jsp' starting page</title>
...
<body>
    ...
    <form action="positionServlet.servlet?method=updatePosition" method="post">
	    <ul class="forminfo">
		    <li><label>岗位编号</label><input name="posid" type="text" class="dfinput" value="${position.posid }"/> </li>
