...
<div class="cart-inner">
    ...
    <div id="product-list" class="cart-tbody">
        ...
        <c:forEach items="${map}" var="cart">
        	<c:set var="totalPrice" value="${ totalPrice + (cart.tbItem.price * cart.num)}"/>
	        <div id="product_11345721" data-bind="rowid:1" class="item item_selected ">
		        <div class="item_form clearfix">
		            ...
		            <div class="cell p-goods">
		                <div class="p-img">
		                	<a href="/item/${cart.tbItem.id }.html" target="_blank">
		                		<img clstag="clickcart|keycount|xincart|p-imglistcart" 
		                		src="${cart.tbItem.images[0]}" alt="${cart.tbItem.title}" width="52" height="52">
		                	</a>
		                </div>    
		                <div class="p-name">
		                	<a href="/item/${cart.tbItem.id }.html" 
		                	clstag="clickcart|keycount|xincart|productnamelink" 
		                	target="_blank">${cart.tbItem.title}</a>
		            ...
		            value="${cart.tbItem.price / 100}" maxFractionDigits="2" minFractionDigits="2"/> </span></div>
		            ...
		            <div class="cell p-quantity" for-stock="for-stock-11345721">
		                <div class="quantity-form" data-bind="">
		                    ...
		                    itemPrice="${cart.tbItem.price}" itemId="${cart.tbItem.id}"
		                     value="${cart.num }" id="changeQuantity-11345721-1-1-0">
		            ...
		            class="cart-remove" href="/cart/delete/${cart.tbItem.id}.html">删除</a>
		            </div>
		        </div>
	        </div> 
        </c:forEach>
        ...
        <div class="ui-ceilinglamp-1" style="width: 988px; height: 49px;"><div class="cart-dibu ui-ceilinglamp-current" style="width: 988px; height: 49px;">
          <div class="control fdibu fdibucurrent">
              ...
              <span class="delete">
                 ...
                 <a href="/cart/delete/all.html" clstag="clickcart|keycount|xincart|clearcartlink" id="remove-batch">
                      	清空购物车
                  </a>
              </span>
              <span class="shopping">
          ...
          <div class="cart-total-2014">
              <div class="cart-button">
                  <span class="check-comm-btns" id="checkout-jd">
                      <a class="checkout" href="http://localhost:8085/order/ordercart.html" 
                  ...
                  <span class="combine-btns" style="display:none">
                      ...
                      <span class="fore2 hide" style="display: inline;">
                          ...
                          <a href="http://localhost:8082/order/order-cart" class="checkout-jd">去易购结算<b></b></a>
                      </span>
                  </span>
              </div>
              <div class="total fr">
