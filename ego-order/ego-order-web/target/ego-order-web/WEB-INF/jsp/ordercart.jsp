...
<form id="orderForm" class="hide" action="/order/save.html" method="post">
    ...
    <div class="goods-suit goods-last">
	 <c:forEach items="${cartList }" var="cart">
		<div class="goods-item goods-item-extra">
			...
			<div class="p-img">
				<a target="_blank" href="/item/${cart.tbItem.id}.html">
					<img src="${cart.tbItem.images[0]}" alt="">
				</a>
			</div>
			<div class="goods-msg">
				<div class="p-name">
				...
				<div class="p-price">
					...
					<strong>￥<fmt:formatNumber
							...
							minFractionDigits="2" value="${cart.tbItem.price / 100 }" /></strong>
					<!--增加预售金额显示 end-->
					<span class="ml20"> ${cart.num} </span> 
